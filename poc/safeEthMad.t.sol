...
contract MadHackTest is Test {
    ...
    function _runAttackOnce() private {
        ...
        emit log_named_uint("Post: times passed                ", madHackSafeETH.passThrough());
    }
...
//    1500000000000000000
//
//  7000000000000000000                                                                    5000000000000000000
// 38036310000000000000
// ├─ emit log_named_uint(key: Post: victimSplitter1.balance     , val: 450000000000000000)
// ├─ emit log_named_uint(key: Pre: victimSplitter2.balance      , val: 450000000000000000)
// ├─ emit log_named_uint(key: Post: madHackSafeETH.getbalance  , val: 1100000000000000000)
// ├─ emit log_named_uint(key: Post: attack.getbalance          , val: 3000000000000000000)
